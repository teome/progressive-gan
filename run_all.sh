...
ds_root=$dt_dir'/data'
chkp_dir='/home/mval/data/progressive_0/logs_0/set_0'
...
sleep 1.1; python cv_condor.py --project-dir $proj_dir --checkpoints-dir $chkp_dir --machine $machine --num-gpus 1 --killer --niter $iters --batchSize 64 --niter-decay 0 --fineSize 32 --loadSize 32 --workers 10 --outf $chkp_dir --dataroot $ds_root --lr 0.0002 --beta1 0.5 --ngpu 1 --beta2 0.999 --max-stage $max_stage --stage-interval 300800 --print-iter-freq 47 --train-log-freq 47 --model-save-freq 235 --image-save-freq 235 --auto-continue
sleep 1.1; python cv_condor.py --project-dir $proj_dir --checkpoints-dir $chkp_dir --machine $machine --num-gpus 1 --killer --niter $iters --batchSize 64 --niter-decay 0 --fineSize 32 --loadSize 32 --workers 10 --outf $chkp_dir --dataroot $ds_root --lr 0.0004 --beta1 0.5 --ngpu 1 --beta2 0.999 --max-stage $max_stage --stage-interval 300800 --print-iter-freq 47 --train-log-freq 47 --model-save-freq 235 --image-save-freq 235 --auto-continue
sleep 1.1; python cv_condor.py --project-dir $proj_dir --checkpoints-dir $chkp_dir --machine $machine --num-gpus 1 --killer --niter $iters --batchSize 64 --niter-decay 0 --fineSize 32 --loadSize 32 --workers 10 --outf $chkp_dir --dataroot $ds_root --lr 0.0020 --beta1 0.5 --ngpu 1 --beta2 0.999 --max-stage $max_stage --stage-interval 300800 --print-iter-freq 47 --train-log-freq 47 --model-save-freq 235 --image-save-freq 235 --auto-continue
